;(function(e) {
  ...
  cd49: function(e, t, r) {
    ...
    m['a']([Object(j['b'])()], k.prototype, 'msg', void 0),
      (k = m['a']([j['a']], k))
    var y = k,
      w = y,
      O = (r('0e4a'), Object(u['a'])(w, f, h, !1, null, '56833017', null)),
      x = O.exports,
      E = { name: 'home', components: { HelloWorld: x } },
      P = E,
      C = Object(u['a'])(P, p, v, !1, null, null, null),
      $ = C.exports
    n['a'].use(c['a'])
    var S = [
      ...
      T = new c['a']({ mode: 'history', base: '/', routes: S }),
      L = T,
      M = r('2f62')
    n['a'].use(M['a'])
    var A = new M['a'].Store({
...
//# sourceMappingURL=app.26448594.js.map
